...
// Source: https://raw.githubusercontent.com/rawrunprotected/hilbert_curves
//
...
void hilbert_index_to_xy(uint32_t n, uint32_t i, uint32_t& x, uint32_t& y) {
    ...
    uint32_t prefix_t0 = prefix_scan(t0);
    uint32_t prefix_t1 = prefix_scan(t1);

    uint32_t a = (((i0 ^ 0xFFFF) & prefix_t1) | (i0 & prefix_t0));
